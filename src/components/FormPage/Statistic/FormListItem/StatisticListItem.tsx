...
// export const SellerListItem = ({ form }: IFormListItem) => {
//     const { handleModal } = React.useContext(ModalContext)

//     const handleCopyClick = (form: any) => {
//         handleModal(<ViewPostModal form={form} />)
//     }
...
//                 <AltTitle>{form.company_name}</AltTitle>
//             </div>
//             <ActionWrapper>
//                 <StyledButton className="copy-button" onClick={() => handleCopyClick(form)}>
